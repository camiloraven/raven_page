...
<?= $this->section('meta_tags') ?>
    ...
    <!-- OG Tags from index.php could be adapted here if needed -->
<?= $this->endSection() ?>
...
<?= $this->section('content') ?>
        ...
        <section class="relative w-full overflow-hidden bg-black -mt-24 flex items-center min-h-[50vh] lg:min-h-0" style="aspect-ratio: 16/3.7;">
            <div class="absolute inset-0 z-0">
                <!-- Imagen centrada en móviles (object-center) y centrada en escritorio también si se desea, o ajustada según necesidad -->
            ...
            <div class="relative z-10 max-w-[1920px] mx-auto px-8 md:px-16 lg:px-32 w-full pt-20">
                <div class="max-w-4xl text-white">
                    ...
                    <!--
                    <h1 class="font-display text-[5vw] sm:text-3xl md:text-4xl lg:text-5xl font-extrabold mb-8 leading-[0.95] sm:leading-none uppercase tracking-tighter">
                        Industry news.<br/>
    ...
    <div class="max-w-[1920px] mx-auto px-8 md:px-16 lg:px-32 py-12">
        <div class="flex justify-between items-center mb-8">
            <h2 class="text-3xl font-bold text-gray-800 text-gray-700 dark:text-gray-300"><?= lang('blog_t.lastPosts') ?></h2>
        </div>
